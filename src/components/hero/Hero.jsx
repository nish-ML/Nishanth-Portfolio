...
function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#FFFDF7] py-[120px]"
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-[#FFD54F]/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#FFC107]/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      </div>

      <div className="max-w-[1280px] mx-auto px-8 sm:px-12 relative z-10 w-full">
        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate="visible"
          className="grid lg:grid-cols-12 gap-10 md:gap-14 items-center max-w-[1140px] mx-auto"
        >
          {/* Left Content (7 columns on large screen) */}
          <div className="lg:col-span-7 space-y-10 text-center flex flex-col items-center justify-center w-full">
            <motion.div variants={itemVariants} className="space-y-4 w-full flex flex-col items-center">
              ...
              <h1 className="text-6xl sm:text-7xl lg:text-8xl xl:text-[5.5rem] font-black text-[#1E293B] leading-[0.9] uppercase tracking-tighter text-center">
                Hi, I'm <br className="sm:hidden" />
                <span className="block whitespace-nowrap text-[#FFC107] outline-text-dark font-black tracking-tighter select-all">{personalInfo.name}</span>
              </h1>

              <p className="text-lg sm:text-2xl font-black text-[#FFB300] uppercase tracking-widest pt-2 text-center w-full">
                // {personalInfo.title}
              </p>
            </motion.div>
            ...
            >
              <a
                href="#projects"
                className="btn-primary group magnetic-hover rounded-full py-4 px-10"
              >
              ...
              <a
                ...
                className="btn-secondary magnetic-hover rounded-full py-4 px-10"
              >
            ...
            <motion.div
              variants={itemVariants}
              className="flex flex-wrap justify-center gap-4 pt-2 w-full"
            >
              <a
          ...
          >
            <motion.div
              ...
              className="relative w-72 sm:w-80 md:w-96 lg:w-full max-w-md"
            >
